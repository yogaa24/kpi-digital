...
if (!isset($_SESSION['id_user'])) {
   ...
   $archivec = "SELECT bulan FROM tbar_archive WHERE id_user = $id_userdd  group by bulan";
                                    ...
                                    <table id="datatablenya" class="table align-midle table-hover table-bordered">
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <center><?= round(getnilaiaa($connarc,$row['bulan'],$id_userdd),2) ?></center>
                                                </td>
                                                <td  style="color:<?= getsfo( getnilaiaa($connarc,$row['bulan'],$id_userdd)) ?>">
                                                    <center><?= getstatad( getnilaiaa($connarc,$row['bulan'],$id_userdd)) ?></center>
                                                </td>
                                                <td>
                                                    <center>
