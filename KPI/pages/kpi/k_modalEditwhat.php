<div class="modal fade" id="EditWhatModal<?=$res['id_what']?>" tabindex="-1" aria-labelledby="EditModalLabel" aria-hidden="true">
  <div class="modal-dialog modal-lg">
    <div class="modal-content">
      <div class="modal-header">
        <h5 class="modal-title fw-bold" id="EditModalLabel">Edit What</h5> 
        <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
      </div> 
      <div class="modal-body">
        <form method="POST" action="" class="input">
        <input type="input" hidden value="<?= $res['id_what'];?>" class="form-control" name="idkw" >
            ...
            <div class="input-group mb-3">
                ...
                <textarea type="input" value="<?=$res['indikatorwhat'];?>" class="form-control" name="indikatorwhat" placeholder="Tujuan KPI" aria-label="Tujuan KPI" aria-describedby="tujuan" ><?php echo $res['indikatorwhat']; ?></textarea>
            </div>      
        </div>
