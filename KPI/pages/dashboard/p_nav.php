<nav class="app-header navbar navbar-expand bg-body"> <!--begin::Container-->
    <div class="container-fluid"> <!--begin::Start Navbar Links-->
        <ul class="navbar-nav nav-underline">
            ...
            <li class="nav-item d-none d-md-block"> <a href="home-kpi" class="nav-link">Detail KPI</a> </li>
            <?php if($jabatan=="Kabag"){?>
            <li class="nav-item d-none d-md-block"> <a href="kpikabag" class="nav-link">KPI Anggota</a> </li>
            <?php } ?>
            <?php if($leveel==4){?>
            <li class="nav-item d-none d-md-block"> <a href="kpikadep" class="nav-link">KPI Anggota</a> </li>
            <?php } ?>
            <li class="nav-item d-none d-md-block"> <a href="skillstandard" class="nav-link">Skill Standard</a> </li>
